...
static Property vhost_user_console_pci_properties[] = {
    DEFINE_PROP_END_OF_LIST(),
};

static void vhost_user_console_pci_realize(VirtIOPCIProxy *vpci_dev, Error **errp)
{
...
static void vhost_user_console_pci_class_init(ObjectClass *klass, void *data)
{
    ...
    device_class_set_props(dc, vhost_user_console_pci_properties);
